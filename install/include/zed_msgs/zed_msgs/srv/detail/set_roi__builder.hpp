...
class Init_SetROI_Event_response
{
public:
  explicit Init_SetROI_Event_response(::zed_msgs::srv::SetROI_Event & msg)
  : msg_(msg)
  {}
  ::zed_msgs::srv::SetROI_Event response(::zed_msgs::srv::SetROI_Event::_response_type arg)
  {
...
private:
  ::zed_msgs::srv::SetROI_Event msg_;
};

class Init_SetROI_Event_request
{
public:
  explicit Init_SetROI_Event_request(::zed_msgs::srv::SetROI_Event & msg)
  : msg_(msg)
  {}
  Init_SetROI_Event_response request(::zed_msgs::srv::SetROI_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_SetROI_Event_response(msg_);
  }
...
class Init_SetROI_Event_info
{
public:
  Init_SetROI_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_SetROI_Event_request info(::zed_msgs::srv::SetROI_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_SetROI_Event_request(msg_);
  }
...
template<>
inline
auto build<::zed_msgs::srv::SetROI_Event>()
{
  return zed_msgs::srv::builder::Init_SetROI_Event_info();
}
