...
inline std::string to_yaml(const SetSvoFrame_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use zed_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const zed_msgs::srv::SetSvoFrame_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  zed_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use zed_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const zed_msgs::srv::SetSvoFrame_Event & msg)
{
  return zed_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<zed_msgs::srv::SetSvoFrame_Event>()
{
  return "zed_msgs::srv::SetSvoFrame_Event";
}

template<>
inline const char * name<zed_msgs::srv::SetSvoFrame_Event>()
{
  return "zed_msgs/srv/SetSvoFrame_Event";
}

template<>
struct has_fixed_size<zed_msgs::srv::SetSvoFrame_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<zed_msgs::srv::SetSvoFrame_Event>
  : std::integral_constant<bool, has_bounded_size<service_msgs::msg::ServiceEventInfo>::value && has_bounded_size<zed_msgs::srv::SetSvoFrame_Request>::value && has_bounded_size<zed_msgs::srv::SetSvoFrame_Response>::value> {};

template<>
struct is_message<zed_msgs::srv::SetSvoFrame_Event>
  : std::true_type {};
